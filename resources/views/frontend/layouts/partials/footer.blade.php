            ...
            <div class="row g-5">
                ...
                <div class="col-6 col-lg-2">
                    ...
                    <ul class="footer-links list-unstyled">
                        ...
                        <li><a href="category.html"><i class="bi bi-chevron-right"></i> Danh mục bài viết</a></li>
                    </ul>
                </div>
                <div class="col-6 col-lg-2">
                    <h3 class="footer-heading">Danh mục bài viết</h3>
                    <ul class="footer-links list-unstyled">
                        <li><a href="category.html"><i class="bi bi-chevron-right"></i> Xã hội</a></li>
                        <li><a href="category.html"><i class="bi bi-chevron-right"></i> Thể thao</a></li>
                        <li><a href="category.html"><i class="bi bi-chevron-right"></i> Thực phẩm</a></li>
                        <li><a href="category.html"><i class="bi bi-chevron-right"></i> Chính trị</a></li>
                        <li><a href="category.html"><i class="bi bi-chevron-right"></i> Nghệ thuật</a></li>
                        <li><a href="category.html"><i class="bi bi-chevron-right"></i> Du lịch</a></li>
